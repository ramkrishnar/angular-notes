...
updateuser(e,i){
  ...
  this.emp.id=e.id;
 this.emp.name=e.name;
 this.emp.mobile=e.mobile
this.emp.city=e.city;
}
onUpdate(i){
  i=i-1;
 this.user[i].id=this.emp.id
 this.user[i].name=this.emp.name;
 this.user[i].mobile=this.emp.mobile;
 this.user[i].city=this.emp.city; 
}
saveAddress(){
